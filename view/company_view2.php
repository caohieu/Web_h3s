                ...
                <tr>
                    <td>
                        <table border="1" width="700px">
                            ...
                            <?php if(!empty($firstName[1][0])) include "companyRow/row/row2_1.php"?>
                            <?php if(!empty($firstName[1][1])) include "companyRow/row/row2_2.php"?>
                            <?php if(!empty($firstName[1][2])) include "companyRow/row/row2_3.php"?>
                            <?php if(!empty($firstName[1][3])) include "companyRow/row/row2_4.php"?>
                            <?php if(!empty($firstName[1][4])) include "companyRow/row/row2_5.php"?>
                        </table>
                    </td>
                </tr>
            </table>
